...
//warning if you want more than 6 menus, you must turn handle_lvgl_for_app(s, page, true, true); to handle_lvgl_for_app(s, page, true, false); (to desactivate the app swaper)
